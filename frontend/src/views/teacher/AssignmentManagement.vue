    ...
    <div class="content">
      ...
      <div class="assignments-container">
        ...
        >
          ...
          <el-table-column prop="releaseAt" label="发布时间" width="170">
            <template #default="{row}">
          ...
          <el-table-column label="操作" width="160" fixed="right">
            <template #default="{row}">
              ...
              >发布</el-button>
              <el-button size="small" style="background-color: #5ECD5E; color: white;" @click="viewSubmissions(row.id)">查看提交</el-button>
